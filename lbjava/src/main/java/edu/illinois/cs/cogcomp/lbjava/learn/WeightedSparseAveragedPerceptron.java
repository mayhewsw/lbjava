...
public class WeightedSparseAveragedPerceptron extends SparsePerceptron {
     ...
     * {@link WeightedSparseAveragedPerceptron.AveragedWeightVector}.
     **/
     ...
     * the empty string.
     **/
    public WeightedSparseAveragedPerceptron() {
        this("");
    }
     ...
     **/
    public WeightedSparseAveragedPerceptron(double r) {
        this("", r);
    }
     ...
     **/
    public WeightedSparseAveragedPerceptron(double r, double t) {
        this("", r, t);
    }
     ...
     **/
    public WeightedSparseAveragedPerceptron(double r, double t, double pt) {
        this("", r, t, pt);
    }
     ...
     **/
    public WeightedSparseAveragedPerceptron(double r, double t, double pt, double nt) {
        this("", r, t, pt, nt);
    }

    /**
     * Initializing constructor. Sets all member variables to their associated settings in the
     * {@link WeightedSparseAveragedPerceptron.Parameters} object.
     *
     * @param p The settings of all parameters.
     **/
    public WeightedSparseAveragedPerceptron(WeightedSparseAveragedPerceptron.Parameters p) {
        this("", p);
    }
     ...
     **/
    public WeightedSparseAveragedPerceptron(String n) {
     ...
     * @param r The desired learning rate value.
     **/
    public WeightedSparseAveragedPerceptron(String n, double r) {
     ...
     * @param t The desired threshold value.
     **/
    public WeightedSparseAveragedPerceptron(String n, double r, double t) {
     ...
     * @param pt The desired thickness.
     **/
    public WeightedSparseAveragedPerceptron(String n, double r, double t, double pt) {
        this(n, r, t, pt, pt);
    }
     ...
     * @param nt The desired negative thickness.
     **/
    public WeightedSparseAveragedPerceptron(String n, double r, double t, double pt, double nt) {
        super(n);
     ...
     * @param p The settings of all parameters.
     **/
    public WeightedSparseAveragedPerceptron(String n, WeightedSparseAveragedPerceptron.Parameters p) {
        super(n);
        setParameters(p);
    }
    ...
    /**
     * Simply a container for all of {@link WeightedSparseAveragedPerceptron}'s configurable parameters.
     ...
     * class, it must be replaced with an {@link WeightedSparseAveragedPerceptron.AveragedWeightVector}.
     *
     * @author Nick Rizzolo
     **/
    public static class Parameters extends SparsePerceptron.Parameters {
        ...
        public void setParameters(Learner l) {
            ((WeightedSparseAveragedPerceptron) l).setParameters(this);
        }
    }
